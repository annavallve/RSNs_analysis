%% NETS ANALYSIS ON 100 ICs WITH ORDER NETWORKS
...
% define files & data
drdir = '/Users/anna/Desktop/TFG/Results/dr_100ICs/dr_stage1';
goodnodes='/Users/anna/Desktop/TFG/Results/dr_100ICs/goodnodes_100ICs.txt'; 
...
ts.ts(:,1:N_goodnodes) = timeseries_ALL(:,[3, 14, 16, 17, 31, 40, 52, 46, 9, 26, 41, 55, 6, 12, 20, 23, 28, 32, 4, 7, 11, 24, 25, 35, 38, 5, 10, 43, 45, 48, 18, 21, 30, 34, 36, 37, 53, 1, 8, 33, 44, 49, 50, 51, 56, 2, 15, 19, 27, 22, 39, 42, 13, 29, 47, 54]);

% number of subnetworks inside each RSN
net_sum = [8, 10, 12, 15, 7, 4]; % absolute frequency
net_cum = [0, 8, 18, 30, 45, 52, 56]; % cumulative absolute frequency starting at 0
...
imagesc(mean_dif_AMP, [-0.1 0.1]); colormap (cmap); title ('Ordered paired differences (POST - PRE) for 100 ICs', 'fontsize', 20)
set(gca, 'YTickLabel', '');
...
% plot of ordered amplitudes with t-test
...
hold on
xline(8.5); xline(18.5); xline(30.5); xline(45.5); xline(52.5)
yline(8.5); yline(18.5); yline(30.5); yline(45.5); yline(52.5)
set(gca, 'XTickLabel', '');
set(gca, 'YTickLabel', '');
text(3, 58, 'Visual', 'fontsize', 15); text(11, 58, 'Sensory', 'fontsize', 15); text(22, 58, 'Parietal', 'fontsize', 15)
text(36, 58, 'Executive', 'fontsize', 15); text(47, 58, 'DMN', 'fontsize', 15); text(52, 58, 'Cerebellum', 'fontsize', 15)
text(-6, 5, 'Visual', 'fontsize', 15); text(-6, 14, 'Sensory', 'fontsize', 15); text(-6, 25, 'Parietal', 'fontsize', 15)
text(-6, 38, 'Executive', 'fontsize', 15); text(-4, 49, 'DMN', 'fontsize', 15); text(-7, 54, 'Cerebellum', 'fontsize', 15)
...
for i=1:length(net_sum)
    for j=1:length(net_sum)
        n = sum(mat_dif_CORR_anticorr(1+net_cum(i):net_cum(i+1),1+net_cum(j):net_cum(j+1)), 'all')/sum(mat_pre_CORR_anticorr(1+net_cum(i):net_cum(i+1),1+net_cum(j):net_cum(j+1)), 'all')*100;
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_CORR_anticorr, [-300 300]); colormap (cmap); title ('Anticorrelation Changes', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
...
for i=1:length(net_sum)
    for j=1:length(net_sum)
        n = sum(mat_dif_PCORR_anticorr(1+net_cum(i):net_cum(i+1),1+net_cum(j):net_cum(j+1)), 'all')/sum(mat_pre_PCORR_anticorr(1+net_cum(i):net_cum(i+1),1+net_cum(j):net_cum(j+1)), 'all')*100;
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_PCORR_anticorr, [-250 250]); colormap (cmap); title ('Partial Anticorrelation Changes', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_COV_p_inc, [-20 20]); colormap (cmap); title ('Positive Covariance Changes (increase)', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_COV_p_dec, [-20 20]); colormap (cmap); title ('Positive Covariance Changes (decrease)', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_COV_n_inc, [-20 20]); colormap (cmap); title ('Negative Covariance Changes (less negative)', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
...
figure('Position', [300, 300, 800, 800], 'Color', 'White')
imagesc(percent_COV_n_dec, [-20 20]); colormap (cmap); title ('Negative Covariance Changes (more negative)', 'fontsize', 20)
hold on
xline(1.5); xline(2.5); xline(3.5); xline(4.5); xline(5.5)
yline(1.5); yline(2.5); yline(3.5); yline(4.5); yline(5.5)
set(gca, 'XTickLabel', '');
